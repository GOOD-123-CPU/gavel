 ...
 */
@Tag(name = "Messages", description = "留言板")
@RestController
...
public class MessagesController {
    ...
    public R page(@RequestParam Map<String, Object> params,MessagesEntity messages, HttpServletRequest request){
    	if(!request.getAttribute(com.gavel.interceptor.AuthorizationInterceptor.ATTR_ROLE).toString().equals("管理员")) {
    		messages.setUserid((Long)(Long) request.getAttribute(com.gavel.interceptor.AuthorizationInterceptor.ATTR_USER_ID));
    	}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		QueryWrapper<MessagesEntity> wrapper = new QueryWrapper<MessagesEntity>();
		if(map.get("remindstart")!=null) {
		...
		long count = messagesService.count(wrapper);
