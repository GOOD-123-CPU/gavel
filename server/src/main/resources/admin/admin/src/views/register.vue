    ...
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(229, 238, 229, 0.07);borderRadius:10px">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
															<!-- <div v-if="tableName=='members'" class="input-group">
			   <div class="label">用户名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.yonghuming" class="input" type="text" placeholder="用户名">
			   </div>
			 </div> -->
			<el-form-item label="用户名" class="input" v-if="tableName=='members'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='members'">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='members'">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='members'">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='members'">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='members'">
			...
			<el-form-item label="地址" class="input" v-if="tableName=='members'">
