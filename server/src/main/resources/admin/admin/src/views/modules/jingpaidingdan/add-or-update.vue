          ...
          <el-form-item class="input"v-if="ruleForm.shangpinmingcheng" label="商品名称" prop="shangpinmingcheng">
              <el-input v-model="ruleForm.shangpinmingcheng" 
                placeholder="商品名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商品类型" prop="categories">
          <el-input v-model="ruleForm.categories" 
              placeholder="商品类型" clearable  :readonly="ro.categories"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商品类型" prop="categories">
              <el-input v-model="ruleForm.categories" 
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                            ...
                                                            this.$http({
              url: `option/auction-items/shangpinmingcheng`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
    ...
    shangpinmingchengChange () {
      this.$http({
        url: `follow/auction-items/shangpinmingcheng?columnValue=`+ this.ruleForm.shangpinmingcheng,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    yonghumingChange () {
      this.$http({
        url: `follow/members/yonghuming?columnValue=`+ this.ruleForm.yonghuming,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
                                                                                if(data.data.shangpinleixing){
